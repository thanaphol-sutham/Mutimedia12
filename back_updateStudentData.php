...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $file_temp = $_FILES['Std_image']['tmp_name'];
       ...
       if (empty($Std_name)) {
        ...
        updateStudentData($uploaded_image,$file_temp, $Std_id, $Std_code,$Std_name,$Std_email,$Std_tel,$Std_image,$Std_address,$Std_ability,$Std_port);
       }
}
?>
<!DOCTYPE html>
...
<div class="subscribe-newsletter-area">
  ...
  <form  method="post" enctype="multipart/form-data">
    ...
    <input type="text" id="fname" name="Std_code" value="<?php echo editStudentGruop($_GET['id'])[0]; ?>">

    <label for="fname">ชื่อ-นามสกุล: <span style="color: red;"><?php echo "$name_erorr"?></span></label>
    <input type="text" id="lname" name="Std_name"value="<?php echo editStudentGruop($_GET['id'])[1]; ?>">

    <label for="fname">อีเมล:</label>
    <input type="text" id="lname" name="Std_email" value="<?php echo editStudentGruop($_GET['id'])[2]; ?>">

    <label for="fname">เบอร์โทรศัพท์:</label>                           
    <input type="text" id="lname" name="Std_tel" value="<?php echo editStudentGruop($_GET['id'])[3]; ?>">

    <label class="form-label" for="customFile">รูปภาพ: <span style="color: red;"><?php echo "$img_erorr"?></span></label>
    <input type="file" name="Std_image" class="form-control" id="customFile"  value="vvdvdv" />   
    <label for="fname">ที่อยู่:</label>
    <input type="text" id="lname" name="Std_address" value="<?php echo editStudentGruop($_GET['id'])[5]; ?>">
    <label  for="fname">ความสามารถ:</label>
    <input type="text" id="lname" name="Std_ability"value="<?php echo editStudentGruop($_GET['id'])[6]; ?>" >
    <label for="fname">ผลงาน:</label>
    <input type="text" id="lname" name="Std_port"value="<?php echo editStudentGruop($_GET['id'])[7]; ?>" >
